...
create table if not exists fipe.tb_brand(
    id          int         not null,
    description varchar(30) not null,
    constraint pk_brand primary key(id));

create table if not exists fipe.tb_model(
...
create table if not exists fipe.tb_year_price(
  id           int        not null,
